...
async def read_admins_me(current_admin: models.Admin = Depends(get_current_admin)):
...
# def read_user(admin_id: int, db: Session = Depends(get_db)):
#     db_user = crud.get_admin(db, admin_id=admin_id)
#     if db_user is None:
